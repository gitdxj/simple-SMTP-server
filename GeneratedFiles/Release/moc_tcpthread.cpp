...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_tcpThread_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_tcpThread_t qt_meta_stringdata_tcpThread = {
    {
QT_MOC_LITERAL(0, 0, 9), // "tcpThread"
QT_MOC_LITERAL(1, 10, 13), // "Communication"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "tcpThread\0Communication\0"
};
...
void tcpThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Communication((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (tcpThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&tcpThread::Communication)) {
                *result = 0;
            }
        }
    }
...
void *tcpThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_tcpThread.stringdata))
...
// SIGNAL 0
void tcpThread::Communication(QString _t1)
{
