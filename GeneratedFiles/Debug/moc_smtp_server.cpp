...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SMTP_server_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SMTP_server_t qt_meta_stringdata_SMTP_server = {
    {
QT_MOC_LITERAL(0, 0, 11), // "SMTP_server"
QT_MOC_LITERAL(1, 12, 15), // "onCommunication"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 24), // "on_userList_item_clicked"
QT_MOC_LITERAL(4, 54, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(5, 71, 4) // "item"

    },
    "SMTP_server\0onCommunication\0\0"
    "on_userList_item_clicked\0QListWidgetItem*\0"
    "item"
};
...
void SMTP_server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onCommunication((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_userList_item_clicked((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject SMTP_server::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SMTP_server.data,
...
void *SMTP_server::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SMTP_server.stringdata))
        return static_cast<void*>(const_cast< SMTP_server*>(this));
    if (!strcmp(_clname, "Ui_SMTP_serverClass"))
        return static_cast< Ui_SMTP_serverClass*>(const_cast< SMTP_server*>(this));
